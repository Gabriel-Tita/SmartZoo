...
birds::birds(const string &species_name, const string &health, const int number, const int viewing_platform,
    ...
    : animal(species_name, health, number, viewing_platform, male_number, female_number, attractiveness,
             enclosure_number), can_fly(can_fly) {
}

birds::birds(const birds &other) : animal(other), can_fly(other.can_fly) {
};
